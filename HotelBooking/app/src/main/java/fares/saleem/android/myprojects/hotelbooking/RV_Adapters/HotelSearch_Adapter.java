...
public class HotelSearch_Adapter extends RecyclerView.Adapter<HotelSearch_Adapter.MyViewHolder5> {
    ...
    public HotelSearch_Adapter(Activity activity, ArrayList<Hotel> arr, OnRV_ClickListener listener) {
    ...
    public MyViewHolder5 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder5(LayoutInflater.from(parent.getContext()).
                inflate(R.layout.hotel_search_rv_iv, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder5 holder, int position) {
        if (arr != null && arr.size() != 0) {
            String User_ID = activity.getSharedPreferences("User_SP",
                    activity.MODE_PRIVATE).getString("User_ID", null);
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(activity, "Long click will show Hotel Details ", Toast.LENGTH_LONG).show();
                }
            });
    ...
    public class MyViewHolder5 extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder5(@NonNull View itemView) {
            super(itemView);
            tv_hotelname=itemView.findViewById(R.id.tvHotelName5);
            tv_price_period=itemView.findViewById(R.id.tvHotelPrice_Period5);
            tv_location=itemView.findViewById(R.id.tvLocation5);
            btn_reserve=itemView.findViewById(R.id.btn_Reserve5);
            imgbtn_like=itemView.findViewById(R.id.btnimg_like5);
            img=itemView.findViewById(R.id.imgHotel5);
        }
    }
    public void creatAlert_Resrve(String User_ID, String Hotel_ID, MyViewHolder5 holder,String hotelname) {
    ...
    public void creatAlert_Favorite(String user_id, String Hotel_ID, MyViewHolder5 holder) {
        builder = new AlertDialog.Builder(activity);
        builder.setTitle("alert")
